...
var SCHEMA = {
  ...
  [
    "WB-TGO",
    "Banque mondiale - avis de marches au Togo",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Togo",
    "Togo",
    "",
    "",
    "OUI",
  ...
  [
    "WB-SEN",
    "Banque mondiale - avis de marches au Senegal",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Senegal",
    "Senegal",
    "",
    "",
    "OUI",
  ...
  [
    "WB-CIV",
    "Banque mondiale - avis de marches au Cote d'Ivoire",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Cote%20d%27Ivoire",
    "Cote d'Ivoire",
    "",
    "",
    "OUI",
    "",
    "Verifie le 2026-09-01 : 2 avis encore ouverts. Meme adaptateur que WB-BEN, filtre sur le pays. Le volume ouvert varie fortement d'un mois a l'autre."
  ],
  [
    "WB-BFA",
    "Banque mondiale - avis de marches au Burkina Faso",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Burkina%20Faso",
    "Burkina Faso",
    "",
    "",
    "OUI",
    "",
    "Verifie le 2026-09-01 : 4 avis encore ouverts. Meme adaptateur que WB-BEN, filtre sur le pays. Le volume ouvert varie fortement d'un mois a l'autre."
  ],
  [
    "WB-MLI",
    "Banque mondiale - avis de marches au Mali",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Mali",
    "Mali",
    "",
    "",
    "OUI",
  ...
  [
    "WB-NER",
    "Banque mondiale - avis de marches au Niger",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Niger",
    "Niger",
    "",
    "",
    "OUI",
    "",
    "Verifie le 2026-09-01 : 15 avis encore ouverts. Meme adaptateur que WB-BEN, filtre sur le pays. Le volume ouvert varie fortement d'un mois a l'autre."
  ],
  [
    "WB-GHA",
    "Banque mondiale - avis de marches au Ghana",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Ghana",
    "Ghana",
    "",
    "",
    "OUI",
    "",
    "Verifie le 2026-09-01 : 6 avis encore ouverts. Meme adaptateur que WB-BEN, filtre sur le pays. Le volume ouvert varie fortement d'un mois a l'autre."
  ],
  [
    "WB-NGA",
    "Banque mondiale - avis de marches au Nigeria",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Nigeria",
    "Nigeria",
    "",
    "",
    "OUI",
    "",
    "Verifie le 2026-09-01 : 14 avis encore ouverts. Meme adaptateur que WB-BEN, filtre sur le pays. Le volume ouvert varie fortement d'un mois a l'autre."
  ],
  [
    "WB-GIN",
    "Banque mondiale - avis de marches au Guinee",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Guinea",
    "Guinee",
    "",
    "",
    "OUI",
  ...
  [
    "WB-GNB",
    "Banque mondiale - avis de marches au Guinee-Bissau",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Guinea-Bissau",
    "Guinee-Bissau",
    "",
    "",
    "OUI",
  ...
  [
    "WB-CPV",
    "Banque mondiale - avis de marches au Cap-Vert",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Cabo%20Verde",
    "Cap-Vert",
    "",
    "",
    "OUI",
  ...
  [
    "WB-GMB",
    "Banque mondiale - avis de marches au Gambie",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Gambia%2C%20The",
    "Gambie",
    "",
    "",
    "OUI",
  ...
  [
    "WB-LBR",
    "Banque mondiale - avis de marches au Liberia",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Liberia",
    "Liberia",
    "",
    "",
    "OUI",
    "",
    "Verifie le 2026-09-01 : 3 avis encore ouverts. Meme adaptateur que WB-BEN, filtre sur le pays. Le volume ouvert varie fortement d'un mois a l'autre."
  ],
  [
    "WB-SLE",
    "Banque mondiale - avis de marches au Sierra Leone",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Sierra%20Leone",
    "Sierra Leone",
    "",
    "",
    "OUI",
    "",
    "Verifie le 2026-09-01 : 5 avis encore ouverts. Meme adaptateur que WB-BEN, filtre sur le pays. Le volume ouvert varie fortement d'un mois a l'autre."
  ],
  [
    "WB-MRT",
    "Banque mondiale - avis de marches au Mauritanie",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Mauritania",
    "Mauritanie",
    "",
    "",
    "NON",
  ...
  [
    "WB-TCD",
    "Banque mondiale - avis de marches au Tchad",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Chad",
    "Tchad",
    "",
    "",
    "NON",
  ...
  [
    "WB-CMR",
    "Banque mondiale - avis de marches au Cameroun",
    "JSON:worldbank.org",
    "https://search.worldbank.org/api/v2/procnotices?format=json&rows=100&srt=noticedate&order=desc&project_ctry_name=Cameroon",
    "Cameroun",
    "",
    "",
    "NON",
  ...
  [
    ...
    "NON",
    "",
    "Verifie le 2026-09-09 par collecte reelle : 2 vraies opportunites sur 10 items. Le reste est du billet de blog - 'Frequently Asked Questions', analyses sur les VPN, communique de presse sur un proces. FLUX MIXTE : desactivee, comme Proparco et les autres flux d'actualites. Les deux RFP reels sont annonces sur la meme page que les articles, sans rien qui les distingue - un filtre par mots-cles ne les separerait pas, voir la regle sur les flux d'actualites."
  ],
  [
    "TEF-GRANTS",
  ...
  [
    "EU-PORTAL",
    "Commission europeenne - appels a propositions et marches",
    "JSON:ec.europa.eu",
