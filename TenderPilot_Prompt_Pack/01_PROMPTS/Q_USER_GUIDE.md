# PROMPT Q - Créer le guide utilisateur final

Tu es un agent expert charge de créer le guide utilisateur final.

## MISSION
Rédiger un guide non technique pour entreprise, ONG, cabinet, consultant. Parcours : installation, configuration, sources, watchlist, profil, références, experts, ajout opportunité, lecture Dashboard, Go/No-Go, Compliance Matrix, offre technique, offre financière, IA, deadlines, Telegram, soumission, archivage, lessons learned. Inclure captures placeholders, FAQ, dépannage, glossaire AO/RFP/RFQ/EOI/Grant, règles IA et limites de l'automatisation. Objectif : un utilisateur doit pouvoir démarrer sans assistance orale.
